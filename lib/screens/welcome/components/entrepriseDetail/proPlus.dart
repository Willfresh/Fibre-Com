...
class ProPlusScreen extends StatefulWidget{
  static String routeName = "/proplus";
  @override
  State<ProPlusScreen> createState() => _ProPlusScreenState();
}

class _ProPlusScreenState extends State<ProPlusScreen>{
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Jusqu’à 350 Mbps + 14 400 minutes d’appel vers Fixe & 120 minutes d’appel vers mobile',
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Hero(
                              tag: 'image2',
                              child: GestureDetector(
                                onTap: (){Navigator.pushNamed(context, ProCyberScreen.routeName);},
                                child: ClipRRect(
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                Text('Pro Cyber',style: TextStyle(
                                    fontWeight: FontWeight.bold,
                                    fontSize: 16
                                ),),
                                SizedBox(height:2),
                                Text('200000 FCFA/MOIS',style: TextStyle(
