...
class PlatiniumScreen extends StatefulWidget{
  static String routeName = "/platinium";
  @override
  State<PlatiniumScreen> createState() => _PlatiniumScreenState();
}

class _PlatiniumScreenState extends State<PlatiniumScreen>{
  @override
        ...
        child: Column(
          children: [
            SizedBox(
              ...
              child: Hero(
                tag: 'image3', // Utilisez le même tag que celui de l'image de départ
                child: Stack(
                  children: [
                    Image.asset(
            ...
            Padding(
              ...
              child: Text('Jusqu’à 200 Mbps + 3600 minutes d’appel vers fixe & 120 minutes d’appel vers mobile',
