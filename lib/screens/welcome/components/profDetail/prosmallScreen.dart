...
class ProSmallScreen extends StatefulWidget{
  static String routeName = "/prosmall";
  @override
  State<ProSmallScreen> createState() => _ProSmallScreenState();
}

class _ProSmallScreenState extends State<ProSmallScreen>{
  @override
        ...
        child: Column(
          children: [
            ...
            Padding(
              ...
              child: Text('Jusqu’à 250 Mbps + 14 400 minutes d’appel vers Fixe & 120 minutes d’appel vers mobile',
                        ...
                        children: <Widget>[
                          Container(
                            ...
                            child: Hero(
                              tag: 'image2',
                              child: GestureDetector(
                                onTap: ()=> Navigator.pushNamed(context, ProScreen.routeName),
                                child: ClipRRect(
                                    borderRadius: BorderRadius.circular(10),
                                    child: Image.asset('assets/images/entreprise.jpg')
                                ),
                              ),
                            ),
                          ),
                          ...
                          Padding(
                            ...
                            child: Column(
                              ...
                              children: <Widget>[
                                ...
                                SizedBox(height:2),
                                Text('75000 FCFA/MOIS',style: TextStyle(
